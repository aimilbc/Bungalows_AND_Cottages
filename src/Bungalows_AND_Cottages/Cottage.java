...
public class Cottage extends Booking {
	 ...
	 */
	public Cottage(String n, String c, String from, int nights, String pickedCott,String addss, String phn, String e, String cName, String cNum, String eDate, String sCode, int i, double typeP,  int optNyts) {
		super(n,c,from,nights,pickedCott, addss,phn,e,cName,cNum,eDate,sCode, i);
